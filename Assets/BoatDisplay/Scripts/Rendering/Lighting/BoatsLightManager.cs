...
{
    //[SerializeField] private List<VolumetricLightBeamSD> lights = new List<VolumetricLightBeamSD>();

    //private bool isOpenLights = false; 

    //private void Awake()
    //{
    //    lights = GetComponentsInChildren<VolumetricLightBeamSD>(true).ToList();
    //    //Debug.Log();
