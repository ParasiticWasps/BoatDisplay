...
namespace VolumetricFogAndMist {
    ...
    public class VolumetricFogInspector : Editor {
        ...
        SerializedProperty _fogOfWarEnabled, _fogOfWarReuseOther, _fogOfWarOther, _fogOfWarTexture, _fogOfWarCenter, _fogOfWarSize, _fogOfWarTextureSize, _fogOfWarClearDuration, _fogOfWarRestoreDelay, _fogOfWarRestoreDuration, _fogOfWarSmoothness, _fogOfWarBlur;
        ...
        void OnEnable () {
            ...
            _lightScatteringBrightnessThreshold = serializedObject.FindProperty("_lightScatteringBrightnessThreshold");
            ...
            _fogOfWarClearDuration = serializedObject.FindProperty("_fogOfWarClearDuration");
...
#pragma warning restore 0429
                    ...
                    EditorGUILayout.PropertyField(_lightScatteringBrightnessThreshold, new GUIContent("   Brightness Threshold", "Minimum pixel brightness required to contribute to light shafts. Increase to filter out dim pixels."));
#pragma warning disable 0429
#pragma warning disable 0162
            ...
            if (IsFeatureEnabled(VolumetricFog.SKW_FOG_OF_WAR_ON)) {
                ...
                if (expandFogOfWarSection) {
                    ...
                    if (!_fogOfWarReuseOther.boolValue) {
                        ...
                        EditorGUILayout.PropertyField(_fogOfWarClearDuration, new GUIContent("Clear Duration", "Default clear duration if no duration is specified in the SetFogOfWarAlpha call."));
