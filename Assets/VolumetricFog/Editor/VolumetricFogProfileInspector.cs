...
namespace VolumetricFogAndMist {
	...
	public class VolumetricFogProfileInspector : Editor {
		...
		void OnEnable() {
			...
			lightScatteringBrightnessThreshold = serializedObject.FindProperty("lightScatteringBrightnessThreshold");
		...
		public override void OnInspectorGUI() {
			...
			if (lightScatteringEnabled.boolValue) {
				...
				EditorGUILayout.PropertyField(lightScatteringBrightnessThreshold, new GUIContent("   Brightness Threshold", "Minimum pixel brightness required to contribute to light shafts. Increase to filter out dim pixels."));
